function FindProxyForURL(url, host) {
    ...
    // ----------------------------------------------------------
    // 0. Portkey platform — always DIRECT
    // The dashboard (app.portkey.ai), gateway (api.portkey.ai), and
    // other Portkey infra must never be sent through the gateway proxy.
    // ----------------------------------------------------------
    var portkeyPlatform = [
        ".portkey.ai",
        "portkey.ai"
    ...
    // Routing decision
    // ----------------------------------------------------------
    if (matchesDomain(host, portkeyPlatform)) {
        return DIRECT;
    }
